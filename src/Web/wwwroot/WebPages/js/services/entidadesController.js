...
const baseUrl5 = window.location.hostname === "localhost"
    ? "https://localhost"
    : "https://websystem-api-prod-ctgrd4gfc2e6dudb.westeurope-01.azurewebsites.net";

const port5 = window.location.hostname === "localhost"
    ? "44311"
    : "";
...
class Entidad { 
    ...
    constructor(id, idTipoEntidad, nombre, descripcion, popularidad, activo, ubicacion, fechaAlta, imagen) {
        this.id = id, 
        this.nombre = nombre,
