class WebHeader extends HTMLElement {
    ...
    constructor() {
        ...
        template.innerHTML = `
            ...
            <link rel="stylesheet" href="../WebPages/css/animate.min.css">
            <link rel="stylesheet" href="../WebPages/css/magnific-popup.css">-->


            <style>
                :host { display: block; }

                /* Permite aplicar estilos a elementos del menú */
                .active > a {
                    font-weight: bold;
...
.footer .footer-top {
	padding: 65px 0px;
            ...
            <div class="header-inner">
                    ...
                    <div class="inner">
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-9 col-12"> 
                                <div class="main-menu">
                                    <nav class="navigation">
                                        <ul class="nav menu">
                                            <li data-page="inicio"><a href="home-privada.html">Inicio</a></li>
                                            <li data-page="explorar"><a href="explorar.html">Explorar</a></li>
                                            <li data-page="recompensas"><a href="#">Recompensas</a></li>
                                            <li data-page="puntos"><a href="#">Cómo ganar puntos?</a></li>
                                        </ul>
                                    </nav>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-2 col-12">
                                <div class="get-quote">
                                    <a id="infoUsuario" style="margin: 15px;background: goldenrod;" href="#" class="btn">
                                        Hola invitado, tienes 0 pts.
                                    </a>
                                </div>
                            </div>
				...
				<script src="../WebPages/js/jquery.magnific-popup.min.js"></script>
				<script src="http://cdnjs.cloudflare.com/ajax/libs/waypoints/2.0.3/waypoints.min.js"></script>
				<script src="../WebPages/js/bootstrap.min.js"></script>
				<script src="../WebPages/js/main.js"></script>
        `;
    ...
    marcarPaginaActiva() {
        ...
        const items = this.shadowRoot.querySelectorAll('[data-page]');
        items.forEach(item => {
    ...
    actualizarUsuario() {
        ...
        const puntos = localStorage.getItem("PuntosUsuario") ?? "0";

        const info = this.shadowRoot.querySelector("#infoUsuario");
        info.textContent = `Hola ${nombre}, tienes ${puntos} pts.`;
	}
