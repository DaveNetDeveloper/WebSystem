        ...
        private List<MenuOption> CargarOpcionesMenu(string menu, string rol = "")
        {
            ...
            switch (menu)
            {
                ...
                case MenuOpciones.Marketing:
                    ...
                    opciones.Add(new MenuOption { Nombre = "Envío de In-Apps", Parent = "Marketing", Nivel = 2, Path = this.baseServerPath + "Backoffice/marketing/page.html" });
                    break;

                case MenuOpciones.Informes:

                    opciones.Add(new MenuOption { Nombre = "Informes", Nivel = 1, Path = "#" });
                    opciones.Add(new MenuOption { Nombre = "Procesos automaticos", Parent = "Informes", Nivel = 2, Path = this.baseServerPath + "Backoffice/workService-dashboard.html" });
                    ...
                    opciones.Add(new MenuOption { Nombre = "DataQuery1", Parent = "Informes", Nivel = 2, Path = this.baseServerPath + "Backoffice/informes/dataQuery1-list.html" });
                    opciones.Add(new MenuOption { Nombre = "DataQuery2", Parent = "Informes", Nivel = 2, Path = this.baseServerPath + "Backoffice/informes/dataQuery2-list.html" });
                    opciones.Add(new MenuOption { Nombre = "DataQuery3", Parent = "Informes", Nivel = 2, Path = this.baseServerPath + "Backoffice/informes/dataQuery3-list.html" });
                    opciones.Add(new MenuOption { Nombre = "DataQuery3", Parent = "Informes", Nivel = 2, Path = this.baseServerPath + "Backoffice/informes/dataQuery4-list.html" });
                    opciones.Add(new MenuOption { Nombre = "DataQuery4", Parent = "Informes", Nivel = 2, Path = this.baseServerPath + "Backoffice/informes/dataQuery5-list.html" });
                    break;
