...
namespace Test.UnitTest.Entities
{
    ...
    public class UsuarioTests : IEntityTest
    {
        ...
        //    // contraseña vacía
        //    Assert.Throws<ArgumentException>(() => usuario.contrasena = "", "La contraseña no puede estar vacía.");
        //    Assert.Throws<ArgumentException>(() => usuario.contrasena = "   ", "La contraseña no puede estar vacía.");
        //    Assert.Throws<ArgumentException>(() => usuario.contrasena = null, "La contraseña no puede estar vacía.");
        ...
        //    Assert.Throws<ArgumentException>(() => usuario.fechaCreacion = DateTime.Now.AddMinutes(1), "La fecha de creación no puede estar en el futuro.");
